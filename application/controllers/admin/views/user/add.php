    ...
    <div class="panel">
        <header>
            <header class="panel-heading">
                ...
                <a href="<?=make_url( 'admin', 'user', 'add' )?>" class="btn btn-info btn-sm" id="index-add">
        ...
        <form name="myfrom1" class="form-horizontal tasi-form" method="post" action="">
            <table class="table table-striped table-advance table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <div class="col-lg-3 col-sm-4 col-xs-4 input-group"><input type="text" name="infos[username]" class="form-control" placeholder="请输入用户名" /></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="col-lg-3 col-sm-4 col-xs-4 input-group"><input type="text" name="infos[email]" class="form-control" value="" errormsg="请输入正确的Email" /></div>
                    </td>
                </tr>
                <tr>
                    <td class="col-sm-2 col-xs-4 text-right"><label class="control-label">真实姓名</label></td>
                    <td>
                        <div class="col-lg-3 col-sm-4 col-xs-4 input-group"><input type="text" name="infos[truename]" class="form-control" placeholder="" /></div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="col-lg-8 col-sm-8 col-xs-8 input-group">
                            <label>
                                <input type="radio" name="infos[islock]" value="0" checked> 未锁定
                            </label>
                            <label style="padding-left: 20px;">
                                <input type="radio" name="infos[islock]" value="1" > 锁定
                            </label>
                        </div>
                    </td>
                </tr>
