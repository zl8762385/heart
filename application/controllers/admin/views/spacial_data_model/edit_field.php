        ...
        <header>
            <header class="panel-heading">
                ...
                <a href="javascript:void(0)" class="btn btn-info btn-sm" id="index-add">
                    <i class="icon-plus btn-icon"></i>修改字段
                </a>
            </header>
        </header>
        ...
        <div class="panel-body">
            <form class="form-horizontal tasi-form" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3 col-sm-4 col-xs-4 input-group">
                        <select name="infos[type]" class="form-control">
                            ...
                            <option value="<?=$k?>" <?php if( $infos['type'] == $k ):?>selected<?php endif;?>><?=$v?></option>
                            <?php endforeach;?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3 col-sm-4 col-xs-4 input-group">
                        <input type="text" class="form-control" name="infos[field_name]" value="<?=$infos['field_name']?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3 col-sm-4 col-xs-4 input-group">
                        ...
                        <input type="hidden" name="field_k" value="<?=$field_k?>" />
